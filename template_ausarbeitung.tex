...
\subsection{Aufteilung des Algorithmus}

Jetzt betrachten wir, wie Min-Cost Flow Algorithmus am besten implementiert werden kann. Lasst uns, mithilfe von Artikel auf der Website geeksforgeeks.com \cite{GeeksforGeeks2023}, zuerst das Algorithmus schrittweise definieren (übersetzt durch DeepL):
\begin{enumerate}
