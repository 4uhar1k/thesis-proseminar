...
\end{enumerate}
Insgesamt bekommen wir also $\mathbf{O(V\log U)}$. Wir haben also bestätigt, dass Orlins Algorithmus entscheidend schneller ist. Deswegen wird er oder einfachere Orlin-basierte Algorithmen in den Wettbewerben verwendet.
\newpage
