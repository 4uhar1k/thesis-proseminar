...
\begin{enumerate}
    \item Gegeben seien der Quellknoten $\mathbf{S}$ und der Senkenknoten $\mathbf{T}$. Wir haben eine Hilfsfunktion, die überprüft, ob es noch einen gültigen Pfad von $\mathbf{T}$ zur $\mathbf{S}$ gibt. Wenn es keinen mehr gibt, terminiert der Algorithmus.
