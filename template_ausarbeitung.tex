...
den Weg zu finden, wie man die Chinesische Mauer von Spalte 0 bis n-1 mit den geringsten Kosten überqueren kann. Sie beginnen in der ersten Spalte, wobei jede Position durch Klammeräffchen dargestellt wird. Die Kosten für alle Standorte in der ersten Spalte betragen 0. Sie können sich nur horizontal und vertikal bewegen. Sie möchten alle einzigartigen Teile der Chinesischen Mauer besuchen, daher passieren sie niemals Standorte, die ein anderer Alfalfa bereits besucht hat. Die Eingabe sieht wie folgt aus:
\begin{figure}[H]
    \centering
...
In dieser Ausarbeitung ging es um Min-Cost Max-Flow Problem. Wir haben sowie naive, als auch effiziente Implementierung betrachtet,  
