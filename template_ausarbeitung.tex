...
\end{tabular}
\end{center}
Dabei steht $\mathbf{E}$ für die Anzahl der Kanten, $\mathbf{V}$ für die Anzahl der Knoten, $\mathbf{U}$ für die maximale Kapazität im Graph und $\mathbf{C}$ für die maximale Kosten. $\mathbf{SP}$ steht für Shortest-Path Problem und $\mathbf{MF}$ für Maximum-Flow. Orlans Algorithm gilt also als der effizienteste nicht-randomisierte Algorithmus für Min-Cost Flow Problem. Im nächsten Abschnitt betrachten wir diesen Algorithmus näher. 
