...
In meiner Ausarbeitung geht es um Min-Cost Max-Flow - ein Problem, das eine Grundlage bei der Lösung verschiedenster Problemen sein kann und dabei ganz leicht zu verstehen und implementieren ist. Ich werde heute Lösungsimplementierung von diesem Problem zeigen und erklären. Außerdem will ich paar Beispielaufgaben, u.a. aus dem echten Programmierwettbewerb vorzeigen, die mithilfe von Min-Cost Flow gelöst werden können.
\end{abstract}
...
\end{enumerate}
Insgesamt bekommen wir also $\mathbf{O(V\log U)}$. Orlins Algorithmus ist bestimmt schneller, als die naive Implementierung, was wir auch in der nächsten Abteilung in den Experimenten sehen können.
...
\end{tabular}
\end{center}
 Wir haben also nochmal bestätigt, dass Orlins Algorithmus entscheidend schneller ist. Deswegen wird er oder einfachere Orlin-basierte Algorithmen in den Wettbewerben verwendet.
