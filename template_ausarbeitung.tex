...
\begin{itemize}
    \item Shortest (s,t)-path Problem -  Wir haben einen Digraphen G, zwei bestimmte Knoten s und t und einen Kostenvektor c \in $Q_m$. Die Aufgabe
 besteht darin, einen Pfad von s nach t mit minimalen Gesamtkosten zu finden.
    \item Transshipment problem -
    \item Negative-cycle detection problem -
\end{itemize}
