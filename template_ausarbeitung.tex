...
\begin{enumerate}
    ...
    \item search() -
\end{enumerate}
Insgesamt bekommen wir die Laufzeit von $O(V^{2} \cdot E^{2})$ und den Speicherverbrauch von $O(V)$. Dieser Algorithmus passt also ganz gut für Lösung des Problems in relativ kleinen Graphen. Es gibt aber eine andere Lösung, die viel effizienter ist.
