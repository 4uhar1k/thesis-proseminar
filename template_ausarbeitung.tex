...
Orlins Algorithmus gilt als der effizienteste nicht-randomisierte Algorithmus für Min-Cost Flow Problem. In dieser Abteilung betrachten wir diese Lösung näher. \newline
...
\end{tabular}
\end{center}
 In den kleineren Graphen gibt es keine relevante Unterschied zwischen den Algorithmen. Ich würde für die kleineren Graphen die naive Implementierung vorziehen, weil sie einfacher zu verstehen ist. In den Programmierwettbewerben wird aber natürlich Algorithmus von Orlin oder einfachere Orlin-basierte Algorithmen verwendet. Wir haben also nochmal bestätigt, dass Orlins Algorithmus entscheidend schneller ist. Deswegen wird er oder einfachere Orlin-basierte Algorithmen in den Wettbewerben verwendet.
